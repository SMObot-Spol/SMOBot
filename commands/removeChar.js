...
async function execute(interaction) {
	...
	const addBed = {
		...
		description: `Your character remove query returned :`,
		color: 7419530,
...
async function removeCharacter(char, uid, addBed, interaction) {
	...
	try {
		await characterManager.removeCharacter(char.toLowerCase(), uid);
		addBed.fields.push({
